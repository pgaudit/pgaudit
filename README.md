...
Specifies that audit logging should include the number of rows retrieved or affected by a statement. When enabled the number of rows field will be included after the parameter field.
